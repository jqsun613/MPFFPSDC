...
for i in range(5):
    ...
    model_file_name = 'data/result/MPFFPSDC' + str(i) + '--model_' + datafile +  '.model'
    result_file_name = 'data/result/MPFFPSDC' + str(i) + '--result_' + datafile +  '.csv'
    file_AUCs = 'data/result/MPFFPSDC' + str(seed) + str(i) + '--AUCs--' + datafile + '.txt'
    AUCs = ('Epoch\tAUC_dev\tPR_AUC\tACC\tBACC\tPREC\tTPR\tKAPPA\tRECALL')
    model_pathe = 'data/result/weight/' + str(seed) + 'modele' + str(i) + '.pt'
